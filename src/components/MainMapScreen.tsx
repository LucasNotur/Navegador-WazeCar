...
import { Map, AdvancedMarker, useMap, RenderingType } from '@vis.gl/react-google-maps';
import { collection, onSnapshot } from 'firebase/firestore';
import { db, seedDatabase } from '../firebase';
import { StatusBar } from './StatusBar';
import { darkMapStyle } from '../mapStyle';
import { ServiceOrder } from '../types';
import { getUserLocationStrict, updateCachedLocation, getCachedLocation, LocationStatus } from '../utils/geolocation';
import { LoadingSpinner } from './LoadingSpinner';
import { ErrorMessage } from './ErrorMessage';

let hasSeeded = false;

export const MainMapScreen: React.FC<{ onSearch: () => void, onSelectOS: (os: ServiceOrder) => void }> = ({ onSearch, onSelectOS }) => {
  const map = useMap();
